suggest-00-special-ultra:: prep
	suggest/run-batch "${ASPELL} --sug-mode=ultra" suggest/00-special.tab tmp/00-special-ultra-actual
...
suggest-00-special-fast:: prep
	suggest/run-batch "${ASPELL} --sug-mode=fast" suggest/00-special.tab tmp/00-special-fast-actual
...
suggest-00-special-normal:: prep
	suggest/run-batch "${ASPELL} --sug-mode=normal" suggest/00-special.tab tmp/00-special-normal-actual
...
suggest-00-special-slow:: prep
	suggest/run-batch "${ASPELL} --sug-mode=slow" suggest/00-special.tab tmp/00-special-slow-actual
...
suggest-00-special-bad-spellers:: prep
	suggest/run-batch "${ASPELL} --sug-mode=bad-spellers" suggest/00-special.tab tmp/00-special-bad-spellers-actual
...
suggest-00-special-ultra-nokbd:: prep
	suggest/run-batch "${ASPELL} --keyboard=none --sug-mode=ultra" suggest/00-special.tab tmp/00-special-ultra-nokbd-actual
...
suggest-00-special-normal-nokbd:: prep
	suggest/run-batch "${ASPELL} --keyboard=none --sug-mode=normal" suggest/00-special.tab tmp/00-special-normal-nokbd-actual
...
suggest-02-orig-ultra:: prep
	suggest/run-batch "${ASPELL} --sug-mode=ultra" suggest/02-orig.tab tmp/02-orig-ultra-actual
...
suggest-02-orig-fast:: prep
	suggest/run-batch "${ASPELL} --sug-mode=fast" suggest/02-orig.tab tmp/02-orig-fast-actual
...
suggest-02-orig-normal:: prep
	suggest/run-batch "${ASPELL} --sug-mode=normal" suggest/02-orig.tab tmp/02-orig-normal-actual
...
suggest-02-orig-slow:: prep
	suggest/run-batch "${ASPELL} --sug-mode=slow" suggest/02-orig.tab tmp/02-orig-slow-actual
...
suggest-02-orig-bad-spellers:: prep
	suggest/run-batch "${ASPELL} --sug-mode=bad-spellers" suggest/02-orig.tab tmp/02-orig-bad-spellers-actual
...
suggest-02-orig-ultra-nokbd:: prep
	suggest/run-batch "${ASPELL} --keyboard=none --sug-mode=ultra" suggest/02-orig.tab tmp/02-orig-ultra-nokbd-actual
...
suggest-02-orig-normal-nokbd:: prep
	suggest/run-batch "${ASPELL} --keyboard=none --sug-mode=normal" suggest/02-orig.tab tmp/02-orig-normal-nokbd-actual
...
suggest-05-common-ultra:: prep
	suggest/run-batch "${ASPELL} --sug-mode=ultra" suggest/05-common.tab tmp/05-common-ultra-actual
...
suggest-05-common-fast:: prep
	suggest/run-batch "${ASPELL} --sug-mode=fast" suggest/05-common.tab tmp/05-common-fast-actual
...
suggest-05-common-normal:: prep
	suggest/run-batch "${ASPELL} --sug-mode=normal" suggest/05-common.tab tmp/05-common-normal-actual
...
suggest-05-common-slow:: prep
	suggest/run-batch "${ASPELL} --sug-mode=slow" suggest/05-common.tab tmp/05-common-slow-actual
...
suggest-05-common-bad-spellers:: prep
	suggest/run-batch "${ASPELL} --sug-mode=bad-spellers" suggest/05-common.tab tmp/05-common-bad-spellers-actual
...
suggest-05-common-ultra-nokbd:: prep
	suggest/run-batch "${ASPELL} --keyboard=none --sug-mode=ultra" suggest/05-common.tab tmp/05-common-ultra-nokbd-actual
...
suggest-05-common-normal-nokbd:: prep
	suggest/run-batch "${ASPELL} --keyboard=none --sug-mode=normal" suggest/05-common.tab tmp/05-common-normal-nokbd-actual
...
suggest-run-together:: prep
	...
	echo 'hotdoggman' | inst/bin/aspell -a --run-together --run-together-limit=3 | grep -q hotdogman
